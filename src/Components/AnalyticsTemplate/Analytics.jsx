...
function Analytics({chart_i,chart_ii,chart_iii,title,value,illustration}) {
    const data = [
        {
          "name": "Page A",
          "Eranings": 4000,
  ...
  return (
   ...
   <header>
        ...
        <span className='eranings'>Eranings:</span>
      </header>
     ...
     <xAxis/>
        ...
        <Bar dataKey="Eranings" fill="#810551" />
        </BarChart></>
        )}
        {
          chart_ii && (
            <LineChart width={300} height={210} data={data1}
        ...
        <Pie data={data03} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={50} fill="#810551" />
